...
| Хорда: корень / законцовка | 2,56 / 0,19 м | эллипс, ≈2,6 / 0,2 м |
| Поперечное V | 6,0° | 6° |
...
## Сверка с чертежами в плане (plan-top / plan-bottom)

- Крыло: эллипс совпадает ±0,03–0,07 м по хордам (верх и низ); размах 11,23 м.
- Стабилизатор: ужат до 3,22 м / хорда 1,22 м (было 3,44 / 1,84); рули + триммеры.
- Элероны s = 2,14–4,87 м (были 1,98–5,62); закрылки добавлены (s = 0,35–2,14 м).
- Углы установки: крыло 2,0°/−0,5°, стабилизатор 0,0° (по DCS Spitfire IX).
- Шасси: стойки ⌀0,10/0,07 м, колёса ⌀0,62 м (24,5″), колея ±0,86 м.
- Радиаторы вынесены к s ≈ 1,5 м (были у корня); ПВД, прицел GM2, кресло,
  ручка, приборная доска, горловины баков, бортовые огни.
- Нос/хвост чертежа искажены (нос −1,33 м, хвост +1,45 м) — оставлено по ML296
  и спецификации 9,47 м; оверлей: `references/verify_overlay.png`.
- Сетка: 0 открытых рёбер, 0 не-многообразных — годится для 3D-печати.
...
* **Крыло** — 15 сечений по размаху: эллипс хорд 2,56→0,19 м
  до y=5,615 м; поперечное V 6°, крутка, NACA-профиль.
...
* **Оперение** — стабилизатор с рулём высоты, киль (h = 1,56 м) с рулём
